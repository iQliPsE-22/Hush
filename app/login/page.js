      ...
      const updatedFriends = data.map((friend) => {
        if (friend.profilePicture) {
          ...
          if (cachedImage) {
            ...
            const base64Image = `data:${friend.profilePicture.contentType};base64,${Buffer.from(
              friend.profilePicture.data.data,
            ).toString("base64")}`
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-black p-4">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <Image src={"/whisper.svg" || "/placeholder.svg"} alt="Hush Logo" width={80} height={80} className="mx-auto mb-4" />
            ...
            <form className="space-y-6" onSubmit={handleFormSubmit}>
              ...
              <div className="text-center">
                <Link href="#" className="text-sm text-gray-400 hover:text-rose-500 transition-colors">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-400">
                ...
                <Link href="/signup" className="text-rose-500 hover:text-rose-400 font-medium transition-colors">
                  Sign Up
                </Link>
              </p>
            </div>
